...
// import c from '../../../strapi-plugin-content-manager-translations'
module.exports = {
  ...
  //   .default,
  'strapi-plugin-content-manager-translations': require('../../../strapi-plugin-content-manager-translations/admin/src')
    .default,
};
